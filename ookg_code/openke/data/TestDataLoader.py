...
class TestDataLoader(object):
	...
	def __init__(self, in_path = "./", sampling_mode = 'olink', type_constrain = True):
	...
	def read(self):
		...
		self.testTotals = self.lib.getTestTotals()
		self.testTotalo = self.lib.getTestTotalo()
	...
	def __len__(self):
		if self.sampling_mode == "olink":    
			return self.testTotalo
		else:
			return self.testTotals

	def __iter__(self):
		if self.sampling_mode == "olink":
			#self.lib.initTest()
			return TestDataSampler(self.testTotalo, self.sampling_lp_o)
		else:
			#self.lib.initTest()
			return TestDataSampler(self.testTotals, self.sampling_lp_s)